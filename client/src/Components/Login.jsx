        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-300 px-4 py-3 bg-slate-50 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-all duration-300"
            />
          ...
          <button
            type="submit"
            className="w-full py-3 rounded-xl bg-emerald-500 text-white font-semibold text-lg transition-all duration-300 hover:bg-emerald-600 hover:shadow-xl hover:shadow-emerald-300 active:scale-95"
          >
            Login
          </button>
